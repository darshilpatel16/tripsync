...
const features = [
  [
    "Plan together",
    "Build one shared itinerary instead of losing decisions across group chats.",
  ],
  [
    "Decide together",
    "Propose activities and vote so every traveller has a voice.",
  ],
  [
    "Settle clearly",
    "Record shared costs and calculate simple, transparent repayments.",
  ],
];
